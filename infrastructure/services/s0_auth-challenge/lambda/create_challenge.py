...
<body>
    <h2>ログイン認証コード</h2>
    <p>認証コードをお送りします。</p>
    <div style="background-color: #f0f0f0; padding: 20px; text-align: center; font-size: 32px; letter-spacing: 8px; margin: 20px 0;">
        <strong>{otp}</strong>
    </div>
    <p>このコードは<strong>{OTP_EXPIRY_SECONDS // 60}分間</strong>有効です。</p>
